        ...
        <div ref={slider} className="h-[100vh] w-[400vw] flex flex-wrap relative">
          <section className="panel w-[100vw] h-[100vh] flex md:flex-row flex-col py-6 px-2">
            <div className='md:w-1/2 md:h-full w-full h-1/2'>
              <div className='rounded-[10px] bg-black h-full w-full md:w-[75%] shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]'></div>
            </div>
          ...
          <section className="panel panelGrow w-[100vw] h-[100vh] flex md:flex-row flex-col py-7 px-3">
            <div className='md:w-[60%] md:h-full w-full h-[60%]'>
              <div className='rounded-[10px] bg-black h-full w-full shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]'></div>
            </div>
          ...
          <section className="panel w-[100vw] h-[100vh] flex md:flex-row flex-col py-7 px-3">
            <div className='md:w-1/2 md:h-full w-full h-1/2'>
              <div className='rounded-[10px] bg-black h-full md:w-[75%] w-full shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]'></div>
            </div>
            <div className='md:w-1/2 md:h-full w-full h-1/2 relative'>

        ...
        <div ref={slider} className="h-[100vh] w-[400vw] flex flex-wrap relative">
          <section className="panel w-[100vw] h-[100vh] flex md:flex-row flex-col py-6 px-2">
            ...
            <div className='md:w-1/2 md:h-full w-full h-1/2 relative'>
              ...
              <p className='absolute top-2 right-5 text-5xl sm:text-7xl font-semibold tracking-tight'>01</p>
            ...
            <div className='md:w-[40%] md:h-full w-full h-[40%] relative'>
              ...
              <div className='absolute bottom-0 right-5 w-[85%] sm:w-[75%] md:w-[90%] lg:w-[80%] 2xl:w-[65%] h-[75%] sm:h-[65%] md:h-[55%] lg:h-[65%] xl:h-[55%] 2xl:h-[50%] flex flex-col'>
                ...
                <p className='w-full h-[80%] sm:h-[70%] font-light tracking-tight text-[12px] sm:text-[14px] lg:text-[18px] text-justify'>
                  Sometimes when doing my laundry I stumble upon the dashiki my father left me and think to myself why I wear anything else. This must be grief; How on the day he died I could reason quite clearly. The old and sick deserve the rest and so it was easy to accept. But the scab is uglier than the wound always. It took me two months to visit his grave once I got back home. I believed because I never attended his funeral that I only knew of his death and last I saw he was alive. So for a while I believed only what I saw. That way I could pretend he simply went on an adventure. He was my schrodingers cat.
                </p>
              </div>
            </div>
          </section>
          <section className="panel w-[100vw] h-[100vh] flex md:flex-row flex-col py-7 px-3">
            <div className='md:w-[60%] md:h-full w-full h-[60%] flex items-start justify-evenly'>
              ...
              <div className='rounded-[10px] overflow-hidden h-[83%] sm:h-full w-[45%] shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]'>
          ...
          <section className="panel w-[100vw] h-[100vh] flex md:flex-row flex-col py-7 px-3">
            ...
            <div className='md:w-1/2 md:h-full w-full h-1/2 relative'>
              ...
              <div className='absolute bottom-0 right-5 w-[85%] sm:w-[75%] md:w-[90%] lg:w-[80%] 2xl:w-[65%] h-[75%] md:h-[30%] lg:h-[35%] flex flex-col justify-evenly'>
                <p className='w-full h-fit font-light tracking-tight text-[14px] lg:text-[18px] text-justify'>
                   Dear Dad. I still scratch until it bleeds again. Your seat at the dinner table remains yours. In a letter to Santa I'd ask for you and proceed to be a good boy for three lifetimes. This must be grief, still. What I want is for you to be back. And what I want I can never have. So I remain in constant yearn, The wanting machine.
                </p>
